...
\subsection{神经网络模型}
图神经网络（GNN）和循环神经网络（RNN）是深度学习领域的两类重要模型。
图\ref{fig:gnn_rnn_example}展示了这两种神经网络的结构示意图。
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{图神经网络（GNN）结构}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/RNN.jpg}
        \caption{循环神经网络（RNN）结构}
    \end{subfigure}
    \caption{图神经网络与循环神经网络结构对比}
    \label{fig:gnn_rnn_example}
\end{figure}
